...
export function fromCognitoError(error: any): ApiError {
  switch (error.name) {
    ...
    default:
      return new ApiError(500, 'Internal server error'); //form
  }
}
...
export type UserType = 'individual' | 'manager' | 'admin' | null | undefined;
...
declare module 'next-auth/jwt' {
  // Module Augmentation: This MODIFIES the Session interface in the "next-auth" module
  /**
