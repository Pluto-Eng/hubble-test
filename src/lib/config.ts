...
//   SIGNWELL_API_KEY: z.string(),
//   SIGNWELL_PLUTO_APP_ID: z.string(),
//   SIGNWELL_PLUTO_SIGNER_EMAIL: z.string().email().optional(),
...
//   NEXT_PUBLIC_APP_PORT: z.string().regex(/^\d+$/).optional(),
//   NEXT_PUBLIC_API_URL: z.string().url(),
//   NEXT_PUBLIC_COGNITO_USER_POOL_ID: z.string(),
//   NEXT_PUBLIC_COGNITO_USER_POOL_CLIENT_ID: z.string(),
//   NEXT_PUBLIC_AWS_REGION: z.string(),
//   NEXT_PUBLIC_S3_BUCKET: z.string(),
//   NEXT_PUBLIC_FARGATE_ENDPOINT: z.string().url().optional(),

//   NEXT_PUBLIC_SIGNWELL_LOAN_AGREEMENT_TEMPLATE_ID: z.string(),
//   NEXT_PUBLIC_SIGNWELL_PLEDGE_AGREEMENT_TEMPLATE_ID: z.string(),
//   NEXT_PUBLIC_SIGNWELL_FUND_CONSENT_TEMPLATE_ID: z.string(),

//   ENABLE_ANALYTICS: z.string().optional(),
//   ENABLE_LOGGING: z.string().optional(),
//   ENABLE_TEST_MODE: z.string().optional(),
// });
...
// } else {
//   parsedEnv = publicSchema.parse(process.env);
// }
...
export const config: Config = {
  ...
  services: {
    ...
    signwell: {
      ...
      appId: process.env.SIGNWELL_PLUTO_APP_ID,
      signerEmail: process.env.SIGNWELL_PLUTO_SIGNER_EMAIL || 'bryan@plutocredit.com',
      templates: {
  ...
  //   emails: {
  //     support: parsedEnv.NEXT_PUBLIC_SUPPORT_EMAIL,
  //     documents: parsedEnv.NEXT_PUBLIC_DOCUMENTS_EMAIL,
  //     noreply: parsedEnv.NEXT_PUBLIC_NOREPLY_EMAIL,
  //     test: {
